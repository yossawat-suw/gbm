...
p1 <- ggplot(var.df.test, aes(y=vst.variance.standardized,x=vst.mean,color = subtyping)) + geom_point()
...
```{r}
ggplot(pca.test,aes(x=PC_1,y=PC_2)) +geom_point() + scale_x_continuous(trans='log10') +
