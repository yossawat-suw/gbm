...
#reverse the log+1 
# smrt[["RNA"]]$data <- as((2^(smrt@assays$RNA@layers$data)) - 1, "CsparseMatrix")
```
...
```{r}
smrt.mal.pseudo <- AggregateExpression(smrt.mal,return.seurat = TRUE,group.by = c("Sample","celltype_merge"))


smrt.mal.pseudo@meta.data
smrt[["RNA"]]$counts <- NULL
