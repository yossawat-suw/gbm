...
npc.de.other.markers.list <- lapply(smrt.mal.list, function(x) {
  Idents(x) <- celltype_all
  FindMarkers(x, ident.1 = "NPClike", only.pos = TRUE,min.cells.group = 1,min.cells.feature = 1)
  })
```
```{r}
library(tibble)
