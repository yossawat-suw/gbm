...
# sen_lucy <- read.csv("./lucy_senesence_genes.csv")
# sen_lucy <- colnames(sen_lucy)
# 
# sen_mayo <- readxl::read_xlsx("./senmayo.xlsx")
...
# 
# #saveRDS(gs_all,file = "./gs_all.rds")
# gc()

gs_all <- readRDS(file = "./gs_all.rds")

# print("prepare GBM")
# 
# gbm <- readRDS("./seurat_gbm_qc")
...
#                  BPPARAM = MulticoreParam(workers = (parallel::detectCores()))
#    )
#    return(x)
#  })
# 
...
#  gc()
#  print("save Escape")
# saveRDS(gbm.list,"./gbm_seurat_list_escaped.rds")

print("Load GBM")

gbm.list <- readRDS("./gbm_seurat_list_escaped.rds")
...
saveRDS(gbm.list_positive_TRUE,"./gbm_seurat_list_escaped_normalized_positive_true.rds")
...
saveRDS(all.markers.list,"./gbm_gsea_findallmarker.rds")
...
saveRDS(gbm.combined,file = "./gbm_seurat_processed_normalized_combined.rds")
