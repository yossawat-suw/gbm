...
Idents(gbm.common) <- "donor_id"
gbm.common.list <- SplitObject(gbm.common, split.by = "ident")
gbm.common.list <- gbm.common.list[sort(names(gbm.common.list))]
names(gbm.common.list)
...
gbm.list = gbm.donor_run_raidiation_list[["E26N"]]; mc.cores = 2; signatures = signatures; npcs = 30; min.cell = 3;
...
```
```{r}
integrate_list <- lapply(gbm.donor_run_raidiation_list,integrate_sc_data,signatures = signatures)
```
