...
```
```{r}
fwrite(anno,file = paste("output/annotation/annotation",ncol(anno),"tools",merge,run,unknown,".csv",sep = "_"),row.names = TRUE)
```
...
anno_score[, confidence := apply(.SD, 1, max)/ncol(anno), .SDcols = 2:5]
