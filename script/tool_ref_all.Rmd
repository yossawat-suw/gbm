...
celltypes <- c("celltype", "celltype_merge","celltype_npc_opc")
...
all_celltypes <- c("MESlike","AClike", "NPClike", "OPClike","NPC_OPClike")

chosing <- list(c(1),c(2,5),c(2,3,4),c(1,2,3,4))
