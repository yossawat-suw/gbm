...
sigs <- c( "4metamodules_new_50_mes","2metamodules_NPC_OPC", "3metamodules_new_50", "4metamodules_new_50","npcopc_ac_mes","npcopc_acmes","4pathways")
...
```{r}
write.csv(each.meta.all, paste0("output/tools/scType_", object, "_", sig,"_",run, ".csv"), row.names = TRUE)
```
...
```{r}
write.csv(res.df,paste0("output/tools/SCINA_",object,"_",sig,"_",run,".csv"),row.names = TRUE)
```
...
saveRDS(rts.list,paste0("output/tools/scsorter_rts_",object,"_",sig), compress = TRUE)
```
...
```{r}
write.csv(each.meta.df,paste0("output/tools/scsorter_",object,"_",sig,"_",run,".csv"),row.names = TRUE)
```
