...
score <- transform(score, MESlike2 = as.numeric(MESlike2),
...
```{r}
model.wilcox <- wilcox.test(senescence1 ~ MES, data = smrt.mal@meta.data,
                   exact = FALSE)
...
```
```{r}
non.malig <- list(mac = c("CD14", "AIF1", "FCER1G", "FCGR3A", "TYROBP", "CSF1R"),
